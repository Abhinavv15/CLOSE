    ...
    <BackgroundGrid pattern="grid" className="min-h-screen text-zinc-100 selection:bg-zinc-800">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-5 max-w-7xl mx-auto border-b border-zinc-900">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a
            href="/login"
            className="text-xs px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-zinc-200 transition-all font-medium"
          >
            Sign In
          </a>
          <a
            href="/dashboard"
            className="text-xs px-3.5 py-1.5 rounded-lg bg-white text-zinc-950 font-semibold hover:bg-zinc-200 transition-all shadow-sm"
          >
            Launch Controller
          </a>
        </div>
      ...
      <section className="relative z-10 pt-20 pb-16 px-6 max-w-5xl mx-auto text-center">
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-zinc-900/80 border border-zinc-800 text-[11px] font-mono text-zinc-300 mb-8 backdrop-blur-md">
          <Sparkles className="w-3.5 h-3.5 text-zinc-400" />
          <span>Deterministic Matching + AI Investigation + Ground Truth</span>
        </div>

        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-6">
          CLOSE
          <span className="block text-xl sm:text-3xl font-light text-zinc-400 mt-2">
        ...
        <div className="mb-10 max-w-2xl mx-auto p-4 rounded-xl bg-zinc-900/50 border border-zinc-800 text-xs text-zinc-400 italic text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl shadow-2xl text-left">
          <div className="p-3 border-r border-zinc-800/60">
            <div className="text-[11px] font-mono text-zinc-400 uppercase">Records Processed</div>
            <div className="text-2xl sm:text-3xl font-bold font-tabular text-white mt-1">127</div>
            <div className="text-[10px] text-zinc-400 font-mono mt-0.5">Synthetic Batch 001</div>
          </div>
          <div className="p-3 md:border-r border-zinc-800/60">
            <div className="text-[11px] font-mono text-zinc-400 uppercase">Match Rate</div>
            <div className="text-2xl sm:text-3xl font-bold font-tabular text-emerald-400 mt-1">94.5%</div>
            <div className="text-[10px] text-zinc-400 font-mono mt-0.5">Exact + Multi-source</div>
          </div>
          <div className="p-3 border-r border-zinc-800/60">
            <div className="text-[11px] font-mono text-zinc-400 uppercase">Auto-Resolution Precision</div>
            <div className="text-2xl sm:text-3xl font-bold font-tabular text-white mt-1">98.7%</div>
            <div className="text-[10px] text-zinc-400 font-mono mt-0.5">Zero Hallucinations</div>
          </div>
          <div className="p-3">
            <div className="text-[11px] font-mono text-zinc-400 uppercase">Unresolved Exceptions</div>
            <div className="text-2xl sm:text-3xl font-bold font-tabular text-amber-400 mt-1">7</div>
            <div className="text-[10px] text-zinc-400 font-mono mt-0.5">Escalated to Human Review</div>
          </div>
        </div>
      </section>
